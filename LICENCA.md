...
**Nota:** Este é uma tradução da licença MIT original para facilitar o entendimento. A versão em inglês (arquivo LICENSE) é a versão oficial para fins legais.

Copyright (c) 2025 Marcelo Buzzetti
